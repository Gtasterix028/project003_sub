...
export function SimpleRegistrationForm() {
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen pt-[80px] sm:pt-[60px] md:pt-[295px] lg:pt-[105px] flex justify-center items-start">
        ...
        {/* Mobile & Tablet Black Background */}
        <div className="block lg:hidden absolute inset-0 bg-black z-0" />

        {/* Overlay */}
        <div className="absolute inset-0 bg-black/50 z-0" />

        {/* Registration Card */}
        <Card className="relative z-10 p-4 border border-blue-400 shadow-lg rounded-2xl
                         w-full max-w-[95%]
                         sm:max-w-[300px]
                         md:max-w-[700px]
                         lg:max-w-[500px]
          ...
          >
            {({ isSubmitting }) => (
              <Form>
                ...
                <div className="ml-2 mt-2">
                  <Field name="status" type="checkbox">
                    {({ field }) => (
                      <Checkbox
                        label={
                          <Typography variant="small" color="white" className="flex items-center font-normal text-xs">
                            I agree to the
                ...
                {/* Sign in Redirect */}
                <Typography color="black" className="mt-2 text-center font-normal text-xs">
                  Already have an account?{" "}
                  <Link to="/signin" className="font-medium text-green-900">
                    Sign In
                  </Link>
                </Typography>
              </Form>
