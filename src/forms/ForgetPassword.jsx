...
import { Button } from "@material-tailwind/react"; // still using Material Tailwind Button
import { TextField } from "@mui/material"; // using MUI TextField instead of Material Tailwind Input
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res?.data?.status === "Successful") {
        toast.success("Link successfully sent to email address");
      } else {
        toast.error("Failed to send link, please enter a valid email Id");
      }
    } catch (error) {
